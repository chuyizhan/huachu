...
const form = useForm({
    ...
    period_days: props.plan.period_days,
    features: props.plan.features || [],
    max_premium_posts: props.plan.max_premium_posts,
    can_create_premium_content: props.plan.can_create_premium_content,
    priority_support: props.plan.priority_support,
    badge_color: props.plan.badge_color,
    badge_text_color: props.plan.badge_text_color,
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="mb-6 flex items-center gap-4">
                            ...
                            <h1 class="text-2xl font-semibold">编辑套餐</h1>
                        </div>
