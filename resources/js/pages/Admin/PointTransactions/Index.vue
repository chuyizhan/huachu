...
const pointsMin = ref(props.filters.points_min || '')
const pointsMax = ref(props.filters.points_max || '')
...
const deleteTransaction = (id: number) => {
    if (confirm('确定要删除这个积分交易吗？这将回滚用户积分。')) {
        router.delete(`/admin/point-transactions/${id}`, {
            preserveScroll: true,
        })
    }
}
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="mb-6 flex items-center justify-between">
                            <h1 class="text-2xl font-semibold">积分交易管理</h1>
                            <Link href="/admin/point-transactions/create">
                                <Button>
