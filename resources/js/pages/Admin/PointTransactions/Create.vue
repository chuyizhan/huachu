...
const submit = () => {
    form.post('/admin/point-transactions', {
        preserveScroll: true,
    })
}

const goBack = () => {
    router.visit('/admin/point-transactions')
}
</script>
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="mb-6 flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                ...
                                <h1 class="text-2xl font-semibold">创建积分交易</h1>
                            </div>
                        </div>
                            ...
                            <CardContent>
                                <form @submit.prevent="submit" class="space-y-6">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        >
                                            <option value="earned">获得 (增加积分)</option>
                                            <option value="spent">消费 (使用积分)</option>
                                            <option value="deducted">扣除 (管理员扣除)</option>
                                        </select>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            获得会增加用户积分，消费和扣除会减少用户积分
                                        </p>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            type="number"
                                            required
                                            placeholder="输入积分数量（正数）"
                                            :class="{ 'border-red-500': form.errors.points }"
                                        />
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            请输入正数，系统会根据交易类型自动处理正负号
                                        </p>
                                        <p v-if="form.errors.points" class="text-sm text-red-500">
                                            {{ form.errors.points }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
                                        ...
                                        <div class="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                            ...
                                            <p>
                                                ...
                                                >
                                                    {{ form.type === 'earned' ? '+' : '-' }}{{ Math.abs(form.points) }}
                                                </span>
                                            </p>
