    ...
    <WebLayout>
        ...
        <section class="py-12 ">
            <div class="max-w-full mx-auto px-4">
                <div class="flex items-center justify-between bg-zinc-800 text-white py-2 px-4 rounded-lg mb-6">
                    <h2 class="lg:text-2xl font-bold">分类显示</h2>
                    <Link href="/categories" class="text-sm lg:text-base text-[#ff6e02] hover:text-[#e55a00] font-medium flex items-center gap-1">
                        全部分类
